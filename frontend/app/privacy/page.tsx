  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-gray max-w-none space-y-8">
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mb-3">2. 取得する情報</h2>
          <p className="text-gray-700 leading-relaxed">
            本サービスでは、以下の情報を取得することがあります。
          </p>
          <h3 className="text-lg font-medium text-gray-800 mt-4 mb-2">2.1 ユーザーが提供する情報</h3>
          <ul className="list-disc list-inside text-gray-700 space-y-1">
            <li>アカウント登録時のメールアドレス、ユーザー名</li>
            <li>ユーザーが作成したPC構成データ</li>
          </ul>
          <h3 className="text-lg font-medium text-gray-800 mt-4 mb-2">2.2 自動的に取得される情報</h3>
          <ul className="list-disc list-inside text-gray-700 space-y-1">
            <li>IPアドレス</li>
            <li>ブラウザの種類・バージョン</li>
            <li>アクセス日時</li>
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mb-3">6. エラートラッキング</h2>
          <p className="text-gray-700 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mb-3">7. データの保護</h2>
          <p className="text-gray-700 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mb-3">8. ユーザーの権利</h2>
          <p className="text-gray-700 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mb-3">9. ポリシーの変更</h2>
          <p className="text-gray-700 leading-relaxed">
