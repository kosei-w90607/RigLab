...
export default function TermsPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-8">利用規約</h1>

      <p className="text-sm text-gray-500 dark:text-gray-400 mb-8">最終更新日: 2026年2月7日</p>

      <div className="prose prose-gray max-w-none space-y-8">
        <section>
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">第1条（適用）</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">第2条（サービス内容）</h2>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">第3条（アカウント）</h2>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">第4条（禁止事項）</h2>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">第5条（免責事項）</h2>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">第6条（知的財産権）</h2>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">第7条（サービスの変更・停止）</h2>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">第8条（規約の変更）</h2>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">第9条（準拠法・管轄）</h2>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            本規約の解釈には日本法を準拠法とします。
          </p>
        </section>
