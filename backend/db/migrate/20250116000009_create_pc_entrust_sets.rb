class CreatePcEntrustSets < ActiveRecord::Migration[7.1]
  def change
    create_table :pc_entrust_sets do |t|
    ...
    add_index :pc_entrust_sets, :budget_range
    add_index :pc_entrust_sets, :use_case
